...
(7, 'HyperBowl', 'Surface', 'z = 1/(x^2 + y^2)', 'Makes you feel like you’re falling forever', 'Spicy at the Edges', 9),
(8, 'SaddlePal', 'Surface', 'z = x^2 - y^2', 'Dreams of being a horse saddle', 'Bendy but Balanced', 5),
(9, 'SlinkyLine', 'Curve', 'x = t, y = cos(t), z = sin(t)', 'Moonlights as a phone cord', 'Wiggly and Fun', 8),
(10, 'DonutLord', 'Surface', '(x^2 + y^2 + z^2 - 1)^2 = 4(x^2 + y^2)', 'Lives in bakeries and topological conversations', 'Delightfully Loopy', 10);
