export function Felvetel() {
    try {
        return <>
            <h1>Felvétel</h1>
            <form method="post" action="http://localhost:3000/geometry">
                ...
                <label htmlFor="curvature_personality">Curvature Personality:</label><input type="text" name="curvature_personality"/><br />
